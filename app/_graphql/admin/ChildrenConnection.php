...
class ChildrenConnection extends ObjectType{
...
;
                    $fields[] = [
                        'name' => 'edges',
                        'type' => Types::nonNull(Types::listOf(Types::ChildrenConnectionEdge())),
...
;
                    $fields[] = [
                        'name' => 'nodes',
                        'type' => Types::nonNull(Types::listOf(Types::FileInterface())),
                        'resolve' => $resolverInst->toClosure(),
                        'resolverComposition' => [
                                                            [
                                    ['SilverStripe\GraphQL\Schema\Resolver\DefaultResolver', 'defaultFieldResolver'],
