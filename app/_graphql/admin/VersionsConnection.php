...
class VersionsConnection extends ObjectType{
...
;
                    $fields[] = [
                        'name' => 'edges',
                        'type' => Types::nonNull(Types::listOf(Types::VersionsConnectionEdge())),
...
;
                    $fields[] = [
                        'name' => 'nodes',
                        'type' => Types::nonNull(Types::listOf(Types::PageVersion())),
                        'resolve' => $resolverInst->toClosure(),
                        'resolverComposition' => [
                                                            [
                                    ['SilverStripe\GraphQL\Schema\Resolver\DefaultResolver', 'defaultFieldResolver'],
